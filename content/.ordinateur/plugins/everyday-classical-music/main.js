...
var embeddedMusicData = {
  "01-01": {
    "name": "Symphonic \xC9tudes, op. 13",
    "author": "Schumann",
  ...
  "01-21": {
    "name": "Die Zauberfl\xF6te (The Magic Flute), K. 620",
    "author": "Mozart",
  ...
  "02-03": {
    "name": "Matth\xE4us-Passion ('St. Matthew Passion'), BWV 244",
    "author": "Bach",
  ...
  "03-30": {
    "name": "Die Sch\xF6pfung (The Creation), Hob.XXI/2",
    "author": "Haydn",
  ...
  "05-08": {
    "name": "Pr\xE9lude \xE0 l'apr\xE8s-midi d'un faune (Prelude to the Afternoon of a Faun)",
    "author": "Debussy",
  ...
  "05-11": {
    "name": "Fantas\xEDa para un Gentilhombre",
    "author": "Rodrigo",
  ...
  "05-17": {
    "name": "Missa L'homme arm\xE9 super voces musicales",
    "author": "Josquin",
  ...
  "07-07": {
    "name": 'Lemmink\xE4inen Suite, op. 22, including "The Swan of Tuonela"',
    "author": "Sibelius",
  ...
  "07-23": {
    "name": "String Quartet #13 in B-flat, op. 130 and the Gro\xDFe Fuge, op. 133",
    "author": "Beethoven",
  ...
  "08-08": {
    "name": "String Quartets, op. 76 'Erd\xF6dy'",
    "author": "Haydn",
  ...
  "08-17": {
    "name": "Partitas for Keyboard #1-6, BWV 825-830 (Clavier-\xDCbung I)",
    "author": "Bach",
  ...
  "09-23": {
    "name": "M\xE1 Vlast (My Country), including Vltava (The Moldau)",
    "author": "Smetana",
  ...
  "09-28": {
    "name": "Des Canyons aux \xE9toiles",
    "author": "Messiaen",
  ...
  "10-19": {
    "name": "Symphony #6 'Path\xE9tique' in B minor, op. 74",
    "author": "Tchaikovsky",
  ...
  "10-28": {
    "name": "Daphnis et Chlo\xE9 (ballet and orchestral suites)",
    "author": "Ravel",
  ...
  "11-03": {
    "name": "Die Meistersinger von N\xFCrnberg",
    "author": "Wagner",
  ...
  "11-14": {
    "name": "Pavane pour une infante d\xE9funte",
    "author": "Ravel",
  ...
  "11-28": {
    "name": "\xC9tudes pour piano, Books 1-3",
    "author": "Ligeti",
  ...
  "12-01": {
    "name": "Klavierst\xFCcke (Piano Pieces, 6), op. 118",
    "author": "Brahms",
  ...
  "12-16": {
    "name": "Noches en los Jardines de Espa\xF1a (Nights in the Gardens of Spain)",
    "author": "Falla",
  ...
  "12-27": {
    "name": "Pr\xE9ludes for piano, Books I & II, L 117 & 123",
    "author": "Debussy",
...
var EverydayClassicalMusicPlugin = class extends import_obsidian.Plugin {
  ...
  async onFileCreate(file) {
    const fileCreationTime = (0, import_obsidian2.moment)(file.stat.ctime).valueOf();
...
${content.slice(propertyFieldsEndIndex).trim()}`;
  ...
  async removeLinksBeforeDate(cutoffDate) {
    const files = this.app.vault.getMarkdownFiles();
    const cutoff = (0, import_obsidian2.moment)(cutoffDate, "YYYY-MM-DD");
    for (const file of files) {
      if (this.isDailyNoteFile(file)) {
        const fileDate = (0, import_obsidian2.moment)(file.basename, "YYYY-MM-DD", true);
  ...
  isDailyNoteFile(file) {
    ...
    return (0, import_obsidian2.moment)(file.basename, dailyNoteFormat, true).isValid();
  }
};
var EverydayClassicalMusicSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).addButton((button) => {
      button.setButtonText("Remove links").setCta().onClick(async () => {
        ...
        if ((0, import_obsidian2.moment)(cutoffDate, "YYYY-MM-DD", true).isValid()) {
    ...
    const koFiButton = buttonDiv.createEl("button", { text: "Feed the Markhor \u{1F98C}\u{1FABD}", cls: "ko-fi-button" });
    koFiButton.onclick = () => {
