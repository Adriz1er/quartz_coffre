...
```
___
## [[les dossiers onedrive/OneDrive/second_cerveau/mes notes/pris dans la boite de réception/éléments récurrents passés (non finis)|éléments récurrents passés (non finis)]]
```tasks
